...
public class MessageBoard extends GridBox{
     ...
     */
    public MessageBoard(Coordinate position, int width, int height) {
    ...
    /**
     * Draws a light gray background with black text centered over two lines using
    ...
    public void paint(Graphics g) {
        ...
        g.drawString(topLine, position.x + width/2 - strWidth/2, position.y + 20); // change this
